...
├── sync_identity.py                  # User identity & memory & HANDOFF transit sync script (v3.8: v3.6 MEMORY.md boundary + v3.7 write-back disabled + memory .md-only + artifact-index cleanup)
